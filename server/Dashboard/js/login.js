const BASE_URL = 'http://localhost:8000';
        ...
        async function performLogin(endpoint, data) {
            ...
            try {
                ...
                if (result.status === 'good' && result.access_token) {
                    ...
                    // Redirect based on role (you can customize these URLs)
                    setTimeout(() => {
        ...
        function redirectToDashboard(role) {
            // You can customize these redirect URLs based on your application structure
            const dashboardUrls = {
                'admin': '/Dashboard/templates/admin-dashboard.html',
                'manager': '/Dashboard/templates/manager-dashboard.html',
                'field-manager': '/Dashboard/templates/field-manager-dashboard.html',
                'home-teacher': '/Dashboard/templates/home-teacher-dashboard.html'
            };
